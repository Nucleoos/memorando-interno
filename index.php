...
<html lang="pt-br">
    ...
    <body>
        ...
        <div id="divPrincipal">
            <!-- Section -->
            <section id="corpo">
                <form name="formLogin" method="post" enctype="application/x-www-form-urlencoded" action="cLogin.php"> 
                    <fieldset>
                        <legend>Login</legend>
...
<!--                                <tr>
                                ...
                                <tr>
                                    <td></td>
                                    <td align="left" style="padding-left: 5px; height:  50px;"><span id="recover" ><a href="../MI/vRecover.php">Esqueci minha senha</a></span></td>
                                </tr>                                
                            </table>
