...
class FPDF {
    ...
    function Header() {
        ...
        $this->Cell(0, 0.5, $this->Image("imagens/ufu-logo.png", 9.6), 0, 1, 'C');
        $this->Cell(0, 0.5, utf8_decode("UNIVERSIDADE FEDERAL DE UBERLÂNDIA"), 0, 1, 'C');
        $this->Cell(0, 0.5, utf8_decode("FACULDADE DE COMPUTAÇÃO"), 0, 1, 'C');
        $this->Cell(0, 0.5, "______________________________________________________________________", 0, 1, 'C');
        $this->Ln(0.5);
    }
    ...
    function Footer() {
        ...
        $this->SetY(-2);
        $this->SetTextColor(136, 136, 136);
        $this->Cell(0, 0.5, "_____________________________________________________________________________", 0, 1, 'C');
        $this->Cell(0, 0.5, utf8_decode("UNIVERSIDADE FEDERAL DE UBERLÂNDIA"), 0, 1, 'C');
        $this->Cell(0, 0.5, utf8_decode("FACULDADE DE COMPUTAÇÃO"), 0, 1, 'C');
    }
