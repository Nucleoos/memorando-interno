                                    ...
                                    while ($resultadoUnidades = mysql_fetch_array($selectUnidades)) {
                                        if ($c % 2 != 0) {
                                            ...
                                            <tr style="background-color:#E7E7E6;">
                                                ...
                                                <td align="center" width="4%"><a onClick="encaminhaUnidade(<?php echo $resultadoUnidades[0]; ?>, <?php echo "'" . $resultadoUnidades[1] . "'"; ?>);" href="#" title="Editar"><img src="imagens\edit.png"></a></td>
                                                <td align="center" width="4%"><a onClick="confirmaDeletaUnidade(<?php echo $resultadoUnidades[0]; ?>);" href="#" title="Excluir"><img src="imagens\delete.png"></a></td>
                                            </tr>
                                            <?php
                                            $c++;
                                        } else {
                                    ...
                                    while ($resultadoUsuarios = mysql_fetch_array($selectUsuarios)) {
                                        if ($c % 2 != 0) {
                                            ...
                                            <tr style="background-color:#E7E7E6;">
                                                ...
                                                <td align="center" width="4%"><a onClick="confirmaDeletaUsuario(<?php echo "'" . $resultadoUsuarios[0] . "'"; ?>);" href="#" title="Excluir"><img src="imagens\delete.png"></a></td>
                                            </tr>
                                            <?php
                                            $c++;
                                        } else {
